...
#    Updated: 2022/08/17 13:51:34 by zmoussam         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./mandatory/push_swap.c ./mandatory/instructions/push.c\
			...
			./mandatory/sorting/sortingFunc.c ./mandatory/parssing/free.c\
			./mandatory/sorting/for_norm.c\
...
BNS_SRC = ./bonus/push_swap_bonus.c\
				...
				./bonus/instructions/reverseRotate.c\
